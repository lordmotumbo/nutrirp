...
import {
  LayoutDashboard, Users, CalendarDays, LogOut, Leaf, Menu, X
} from 'lucide-react'
...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-40 w-60 bg-primary-800 text-white flex flex-col
      ...
      >
        ...
        <div className="px-4 py-4 border-t border-primary-700">
          ...
          <button
            ...
            className="mt-3 flex items-center gap-2 text-xs text-primary-200 hover:text-white transition-colors"
          >
