...
import { Plus, Search, Users, Share2 } from 'lucide-react'
import api from '../../api'
    ...
    <div className="space-y-5">
      ...
      {filtered.length === 0 ? (
        <div className="card text-center py-12">
          ...
          <p className="text-xs text-gray-400 mt-1">Crie um novo paciente ou receba um compartilhamento de outro profissional</p>
        </div>
      ) : (
